...
@Component({
  ...
  templateUrl: './year-formly-type.component.html',
  styleUrls: ['./year-formly-type.component.css']
})

export class YearFormlyTypeComponent extends FieldType implements OnInit, FormlyExtension {
