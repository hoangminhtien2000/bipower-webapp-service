...
@Component({
    selector: "app-social-insurance-history-modal",
    templateUrl: "./social-insurance-history-modal.component.html",
    styleUrls: ["./social-insurance-history-modal.component.css"],
})
export class SocialInsuranceHistoryModalComponent implements OnInit, OnChanges, AfterViewInit {
    @Input()
    public idModal: string = "social-insurance-history-modal";
    @Input() value: any = '';
