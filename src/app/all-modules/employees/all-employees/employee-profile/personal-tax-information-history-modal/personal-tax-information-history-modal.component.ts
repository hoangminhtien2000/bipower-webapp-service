...
@Component({
    selector: "app-personal-tax-information-history-modal",
    templateUrl: "./personal-tax-information-history-modal.component.html",
    styleUrls: ["./personal-tax-information-history-modal.component.css"],
})
export class PersonalTaxInformationHistoryModalComponent implements OnInit, OnChanges, AfterViewInit {
    @Input()
    public idModal: string = "personal-tax-information-history-modal";
    @Input() value: any = '';
