    ...
    },
    {
        ...
        children: [
            ...
            },
            {
                path: "contracts",
                loadChildren: () =>
                    import("./contracts/contract.module").then(
                        (m) => m.ContractModule
                    ),
            },
            {
            ...
            },
            {
                path: "contactstatus",
                loadChildren: () =>
                    import("./contactstatus/contactstatus.module").then(
                        (m) => m.ContactstatusModule
                    ),
            },
            {
                path: "aptitute",
            ...
            },
            {
                path: "timemanagement",
                loadChildren: () =>
                    import("./timemanagement/time-management.module").then(
                        (m) => m.TimeManagementModule),
            },
            {
              path: "working-overtime-report",
              loadChildren: () =>
                import("./working-overtime-report/working-overtime-report.module").then(
                  (m) => m.WorkingOvertimeReportModule
                ),
            },
            {
                path: "working-onleave-report",
                loadChildren: () =>
                  import("./working-onleave-report/working-onleave-report.module").then(
                    (m) => m.WorkingOnleaveReportModule
                  ),
            },
          {
            path: 'teams',
